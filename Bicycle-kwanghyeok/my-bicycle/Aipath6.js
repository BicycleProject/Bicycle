...
function Aipath6({ route }) {
    ...
    const handleBeginnerPress = () => {
        setLevel('초보자');
        navigation.navigate('Aipath7', { sidoName: sidoName, sigunguName: sigunguName,
    ...
    return (
        ...
        <View style={styles.container}>
            ...
            <View style={styles.buttonContainer}>
                <TouchableOpacity onPress={handleBeginnerPress}>
                    <View style={styles.button}>
                        <Text style={styles.ButtonText}>초보자</Text>
                    </View>
                </TouchableOpacity>
                <TouchableOpacity onPress={handleIntermediatePress}>
                    <View style={styles.button}>
                        <Text style={styles.ButtonText}>중급자</Text>
                    </View>
                </TouchableOpacity>
                <TouchableOpacity onPress={handleHighPress}>
                    <View style={styles.button}>
